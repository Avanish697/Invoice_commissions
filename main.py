...
def display_page(pathname):
    ...
    return {
        ...
        "/entity": entity_layout,
        "/invoice": invoice_layout,
        "/receivables": receivables_layout,
        "/client": client_layout,
        "/franchise": franchise_layout,
        "/graphs": graphs_layout,
        "/accounts_score": accounts_layout,
        "/deals_closing": deals_closing_layout,
        "/sales_cycle": sales_cycle_layout
    }.get(pathname, overview_layout)
